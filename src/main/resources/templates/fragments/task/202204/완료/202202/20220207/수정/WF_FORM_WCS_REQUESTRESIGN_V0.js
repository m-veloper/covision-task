...
function postRenderingForTemplate() {
    ...
    $("input[name=requestDay]").val(year + "년 " + month + "월 " + date +"일");
    $("input[name=writeDay]").val(year + "년 " + month + "월 " + date +"일");
...
function checkForm(bTempSave) {
    if (bTempSave) {
        ...
        if (document.getElementById("Subject").value == '') {
            ...
            return false;
        }else if (document.getElementById("userRRN1").value == '' || document.getElementById("userRRN2").value == '') {
            Common.Warning('주민등록 번호를 입력하세요.');
            return false;
