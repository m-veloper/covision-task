...
function postRenderingForTemplate() {
    ...
    if (getInfo("Request.templatemode") == "Read") {
        ...
        if (JSON.stringify(formJson.BodyContext) != "{}") {
            ...
            XFORM.multirow.load('', 'json', '#sumTable', 'W', { minLength: 6 });
        }
        //<!--loadMultiRow_Write 끝-->
        
        
        // table 첫번째 row placeholder
        var tblobj = $("#sumTable").find("input[name=itmUnit]")[1];
        $(tblobj).attr("placeholder", "EA, BOX, PK등 입력하세요.");
    }
}
