...
function fn_costChange1() {
	var name1 = $('#a_NAME1').val();
	var name2 = $('#a_NAME2').val();
	var name3 = $('#a_NAME3').val();
	
	if(name2 !=""){
		$('#a_cost_21').val($('#a_cost_11').val());
		
	}
	if(name3 !=""){
		$('#a_cost_31').val($('#a_cost_11').val());
	}
	
}

function fn_costChange2() {
	var name1 = $('#a_NAME1').val();
	var name2 = $('#a_NAME2').val();
	var name3 = $('#a_NAME3').val();
	
	if(name1 !=""){
		$('#a_cost_11').val($('#a_cost_21').val());
		
	}
	if(name3 !=""){
		$('#a_cost_31').val($('#a_cost_21').val());
	}
	
}

function fn_costChange3() {
	var name1 = $('#a_NAME1').val();
	var name2 = $('#a_NAME2').val();
	var name3 = $('#a_NAME3').val();
	
	if(name1 !=""){
		$('#a_cost_11').val($('#a_cost_31').val());
		
	}
	if(name2 !=""){
		$('#a_cost_21').val($('#a_cost_31').val());
	}
