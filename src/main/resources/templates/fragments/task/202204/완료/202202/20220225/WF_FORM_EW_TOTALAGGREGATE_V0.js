...
function fn_rowSub1() {
	...
	var cost2 = parseInt($('#a_cost_12').val() == "" ? 0 : $('#a_cost_12').val().replace(/,/g, ""));
...
function fn_rowSub2() {
	var cost1 = parseInt($('#a_cost_21').val() == "" ? 0 : $('#a_cost_21').val().replace(/,/g, ""));
...
function fn_rowSub3() {
	var cost1 = parseInt($('#a_cost_31').val() == "" ? 0 : $('#a_cost_31').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_32').val() == "" ? 0 : $('#a_cost_32').val().replace(/,/g, ""));
...
function fn_rowSub4() {
	var cost1 = parseInt($('#a_cost_41').val() == "" ? 0 : $('#a_cost_41').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_42').val() == "" ? 0 : $('#a_cost_42').val().replace(/,/g, ""));
...
function fn_rowSub5() {
	var cost1 = parseInt($('#a_cost_51').val() == "" ? 0 : $('#a_cost_51').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_52').val() == "" ? 0 : $('#a_cost_52').val().replace(/,/g, ""));
...
function fn_sum3() {
	var cost1 = parseInt($('#a_cost_15').val() == "" ? 0 : $('#a_cost_15').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_25').val() == "" ? 0 : $('#a_cost_25').val().replace(/,/g, ""));
	var cost3 = parseInt($('#a_cost_35').val() == "" ? 0 : $('#a_cost_35').val().replace(/,/g, ""));
	var cost4 = parseInt($('#a_cost_45').val() == "" ? 0 : $('#a_cost_45').val().replace(/,/g, ""));
	var cost5 = parseInt($('#a_cost_55').val() == "" ? 0 : $('#a_cost_55').val().replace(/,/g, ""));
	var sum = 0;
	sum = cost1+cost2+cost3+cost4+cost5;
...
function fn_a_cost_1_colsum() {
	var cost1 = parseInt($('#a_cost_21').val() == "" ? 0 : $('#a_cost_21').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_31').val() == "" ? 0 : $('#a_cost_31').val().replace(/,/g, ""));
	var sum = 0;
	sum = cost1+cost2;
	$('#a_cost_41').val(sum);
	fn_a_cost_1_colsub();
...
function fn_a_cost_2_colsum() {
	var cost1 = parseInt($('#a_cost_22').val() == "" ? 0 : $('#a_cost_22').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_32').val() == "" ? 0 : $('#a_cost_32').val().replace(/,/g, ""));
	var sum = 0;
	sum = cost1+cost2;
	$('#a_cost_42').val(sum);
...
function fn_a_cost_1_colsub() {
	var cost1 = parseInt($('#a_cost_11').val() == "" ? 0 : $('#a_cost_11').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_41').val() == "" ? 0 : $('#a_cost_41').val().replace(/,/g, ""));
	var sub = 0;
	sub = cost1-cost2;
	$('#a_cost_51').val(CnvtComma(sub));
	
}
function fn_a_cost_2_colsub() {
	var cost1 = parseInt($('#a_cost_12').val() == "" ? 0 : $('#a_cost_12').val().replace(/,/g, ""));
	var cost2 = parseInt($('#a_cost_42').val() == "" ? 0 : $('#a_cost_42').val().replace(/,/g, ""));
	var sub = 0;
	sub = cost1-cost2;
	$('#a_cost_52').val(CnvtComma(sub));
