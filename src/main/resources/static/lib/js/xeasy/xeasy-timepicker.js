...
(function (factory) {
	...
	var methods =
	{
		...
		show: function(e)
		{
            ...
            // modified: readonly �ʵ忡���� �����ϵ��� ����. KJW.2014.06.13
			...
			methods.hide();
            //if( window.console ) console.log(self.css('width') + ':' + list.css('width'));
            //adjust the width of list to that of input - customized 20140410 KIM J. W. 
