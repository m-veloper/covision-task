...
function initButtons() {
    ...
    //배포처 size 키우기
    if (getInfo("SchemaContext.scDeployBtn.isUse") == "Y" && getInfo("SchemaContext.scIPub.isUse") == "Y") {
        chkAction(mType);
...
function inserthtmlrowCC(objTB,taskType, arrCCinfo, arrOu, arrPerson) {
    ...
    if (arrOu != null && arrOu[0] != null) {
        ...
        if (taskType == "Ou") {
            ...
            if (arrCCinfo != null && arrCCinfo[0] != null && arrCCinfo[0] == "receiver") oCell_dp_cc_username.innerHTML = oCell_dp_cc_username.innerHTML + "- " + coviDic.dicMap["lbl_apv_receive"];
        }
    } else {
