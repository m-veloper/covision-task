...
REDIPS.table = (function () {
	...
	var mark_enable = true;      //disable mark
	...
	handler_onmousedown = function (e) {
		...
		if (REDIPS.table.mark_enable === false) {
		    return;
		}
			...
			for (i = 0; i < tr.length; i++) {
				...
				for (j = 0; j < cols; j++) {
					...
					if (cl[i + '-' + j]) {
						...
						c = cl[i + '-' + j];
						//customized 2014.03.27 JIN W. KIM
